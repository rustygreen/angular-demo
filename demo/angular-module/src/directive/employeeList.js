/**
 * @ngdoc directive
 * @name corporate.directive:employeeList
 *
 * @description
 ...
 * @requires Employee
 *
 * @param {array=} selectedEmployees A list of selected employees.
 * @example
 <h4>Static Method</h4>
 <pre>
 <employee-list selected-employees="selectedEmployees"></employee-list>
 </pre>
 */
angular.module('corporate').directive('employeeList', function ($filter, Employee) {
  ...
  return {
    ...
    template: '<div class="list-group">' +
                '<div class="list-group-item employee" ng-class="{active:employee.active}" ng-repeat="employee in employees">' +
                  '<div class="row">' +
